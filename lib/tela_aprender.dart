...
class TelaAprender extends StatelessWidget {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.menu_book, color: CoresApp.primary, size: 28),
                  ...
                  Row(
                    children: [
                      ...
                      const Text("340 gemas", style: TextStyle(color: CoresApp.textMedContrast)),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: CoresApp.accentMagic.withOpacity(0.3),
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(color: CoresApp.accentMagic.withOpacity(0.5), width: 1),
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        const Text(
                          "+80 XP · 5 min",
                          style: TextStyle(color: CoresApp.textMedContrast, fontWeight: FontWeight.bold),
                        ),
                        ElevatedButton.icon(
                          onPressed: () {},
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    if (isComplete)
                      Text(statusText, style: const TextStyle(color: CoresApp.successGreen, fontSize: 12, fontWeight: FontWeight.bold)),
                  ],
                ),
                const SizedBox(height: 4),
                if (!isComplete)
                  Text(subtitle, style: const TextStyle(color: CoresApp.textMedContrast, fontSize: 12)),
  ...
  Widget _buildTrilhaBloqueadaCard({required IconData icon, required String title}) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: CoresApp.textMedContrast.withOpacity(0.5), size: 28),
          const SizedBox(width: 15),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(title, style: TextStyle(color: CoresApp.textMedContrast.withOpacity(0.7), fontSize: 16, fontWeight: FontWeight.bold)),
              const SizedBox(height: 4),
              Row(
                children: [
                  Icon(Icons.lock, size: 12, color: CoresApp.textMedContrast.withOpacity(0.5)),
                  const SizedBox(width: 4),
                  Text("Bloqueado", style: TextStyle(color: CoresApp.textMedContrast.withOpacity(0.5), fontSize: 12)),
                ],
              ),
            ],
          ),
